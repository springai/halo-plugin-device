# Halo-Plugin-Device
这是一款专为Halo建站系统设计的个人设备可视化展示插件，支持高效管理并呈现用户的设备收藏与使用场景。 该插件配置了Halo FinderAPI，并内置了个人设备页面，用户也可根据Finder API文档自行设计个人设备展示页。<BR>
...
### 路由信息
- 模板路径: /templates/devices.html<BR>
- 访问路径：/devices
